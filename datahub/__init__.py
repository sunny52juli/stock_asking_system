...
StockDataLoader / FactorDataLoader / load_market_data / get_available_industries 来自 datahub.loaders;
...
from datahub.data_loader import (
...
__all__ = [
    ...
    "create_stock_data_loader",
    "load_market_data",
    "load_market_data_for_backtest",  # 新增：回测专用数据加载
    "get_available_industries",
    "StockProtocol",
    "FundProtocol",
    "IndexProtocol",
